...
export type ComponentMenuMenuLinkFiltersInput = {
  ...
  blanck?: InputMaybe<BooleanFilterInput>;
...
export type ComponentMenuMenuLinkInput = {
  blanck?: InputMaybe<Scalars['Boolean']>;
...
export type GenericMorph = Author | Category | ComponentMenuMenuLink | I18NLocale | Post | Settingss | Tag | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type Mutation = {
  ...
  deleteSettingss?: Maybe<SettingssEntityResponse>;
  ...
  updateSettingss?: Maybe<SettingssEntityResponse>;
...
export type MutationUpdateSettingssArgs = {
  data: SettingssInput;
};
...
export type Query = {
  ...
  settingss?: Maybe<SettingssEntityResponse>;
...
export type QuerySettingssArgs = {
  publicationState?: InputMaybe<PublicationState>;
};
...
export type Settingss = {
  __typename?: 'Settingss';
...
export type SettingssMenuLinkArgs = {
  filters?: InputMaybe<ComponentMenuMenuLinkFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};

export type SettingssEntity = {
  __typename?: 'SettingssEntity';
  attributes?: Maybe<Settingss>;
  id?: Maybe<Scalars['ID']>;
};

export type SettingssEntityResponse = {
  __typename?: 'SettingssEntityResponse';
  data?: Maybe<SettingssEntity>;
};

export type SettingssInput = {
...
export type Get_All_PostsQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']>;
  start?: InputMaybe<Scalars['Int']>;
  slugCategory?: InputMaybe<Scalars['String']>;
  slugTag?: InputMaybe<Scalars['String']>;
  slugAuthor?: InputMaybe<Scalars['String']>;
...
export const Get_All_PostsDocument = gql`
    query GET_ALL_POSTS($limit: Int, $start: Int, $slugCategory: String, $slugTag: String, $slugAuthor: String, $slugPost: String) {
  posts(
    sort: "createdAt:DESC"
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GET_ALL_POSTS(variables?: Get_All_PostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<Get_All_PostsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<Get_All_PostsQuery>(Get_All_PostsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GET_ALL_POSTS', 'query');
    },
    GET_POST_BY_SLUG(variables?: Get_Post_By_SlugQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<Get_Post_By_SlugQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<Get_Post_By_SlugQuery>(Get_Post_By_SlugDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GET_POST_BY_SLUG', 'query');
    }
  };
}
